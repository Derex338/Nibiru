...
{
    private const float BaseFrameSize = 80f;
    private const float BaseIconSize = 64f;
    private const float BaseTextureScale = 2f;
    ...
    {
        var frameSize = BaseFrameSize * zoom;
        Frame.SetSize = new Vector2(frameSize, frameSize);
        ResearchDisplay.SetSize = new Vector2(BaseIconSize * zoom, BaseIconSize * zoom);
        ResearchDisplay.TextureScale = new Vector2(BaseTextureScale * zoom, BaseTextureScale * zoom);
    }
