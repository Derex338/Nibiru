...
humanoid-profile-editor-faction-subtab-main = Основное
humanoid-profile-editor-faction-subtab-logo = Логотип
humanoid-profile-editor-faction-subtab-roles = Роли
humanoid-profile-editor-faction-subtab-filters = Фильтры
humanoid-profile-editor-faction-logo-label = Логотип (16x16)
humanoid-profile-editor-faction-logo-eraser-button = Ластик
humanoid-profile-editor-faction-logo-clear-button = Очистить
humanoid-profile-editor-faction-logo-8x8-label = Иконка (8x8)
humanoid-profile-editor-faction-logo-clear-8x8-button = Очистить 8x8
humanoid-profile-editor-faction-logo-palette-label = Палитра
humanoid-profile-editor-faction-logo-brush-label = Кисть
humanoid-profile-editor-faction-logo-bg-label = Фон
humanoid-profile-editor-faction-logo-bg-color-button = Цвет фона
humanoid-profile-editor-faction-logo-brush-color-button = Цвет кисти
humanoid-profile-editor-faction-logo-presets-label = Шаблоны
