admin-quick-info-loading = Loading info for entity { ESCAPE($entity) }...
...
admin-quick-info-character-identity = Character: [color=white]{ ESCAPE($character) }[/color] (Identity: [color=white]{ ESCAPE($identity) }[/color])
admin-quick-info-job = Starting Job: [color=white]{ ESCAPE($job) }[/color]
